      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            ...
            <div className="footer-presentations" style={{marginTop:'12px'}}>
              <a href={require('../assets/presentation1.pptx')} download className="btn btn-sm">Academic Temper Proof Presentation</a>
              <a href={require('../assets/presentation2.pptx')} download className="btn btn-sm">Tamper-Proof Records for Uganda</a>
            </div>
          </div>
